 ...
 */
public class ScoreAnalysisActivity extends Activity {
	...
	TextView scoreTestTypeTV;

	@Bind(R.id.scoreDiffLevelTV)
	TextView scoreDiffLevelTV;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		scoreDiffLevelTV.setText(getResources().getStringArray(R.array.difficultie_level)[(int) diffLevel] + "");
		scoreTestTypeTV.setText(getResources().getStringArray(R.array.test_type)[(int) testType] + "");
		...
		for (Test test : testList) {
			...
			totalq += diffCount;
			float testPer = correct / diffCount;
