 ...
 */
public class DynamicTopictListView extends ListView {

    private final int SMOOTH_SCROLL_AMOUNT_AT_EDGE = 15;
    private final int MOVE_DURATION = 150;
    private final int LINE_THICKNESS = 15;

    public ArrayList<TopicReplanData> mSubjectList;
    ...
    public DynamicTopictListView(Context context) {
        super(context);
        init(context);
    }

    public DynamicTopictListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public DynamicTopictListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        DragNDropTopicListAdapter adapter = ((DragNDropTopicListAdapter) getAdapter());
    ...
    private void swapElements(ArrayList arrayList, int indexOne, int indexTwo) {
        long tempIndex = ((TopicReplanData) arrayList.get(indexOne)).getIdIndex();
        ((TopicReplanData) arrayList.get(indexOne)).setIdIndex(((TopicReplanData) arrayList.get(indexTwo)).getIdIndex());
        ((TopicReplanData) arrayList.get(indexTwo)).setIdIndex(tempIndex);
        TopicReplanData temp = (TopicReplanData) arrayList.get(indexOne);
    ...
    public void setCheeseList(ArrayList<TopicReplanData> subjectList) {
