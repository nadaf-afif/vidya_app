 ...
 */
public class DynamicSubjectListView extends ListView {

    private final int SMOOTH_SCROLL_AMOUNT_AT_EDGE = 15;
    private final int MOVE_DURATION = 150;
    private final int LINE_THICKNESS = 15;

    public ArrayList<SubjectReplanData> mSubjectList;
    ...
    public DynamicSubjectListView(Context context) {
        super(context);
        init(context);
    }

    public DynamicSubjectListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public DynamicSubjectListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        DragNDropSubjectListAdapter adapter = ((DragNDropSubjectListAdapter) getAdapter());
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mSubjectList, originalItem, getPositionForView(switchView));
    ...
    private void swapElements(ArrayList arrayList, int indexOne, int indexTwo) {
        long tempIndex = ((SubjectReplanData) arrayList.get(indexOne)).getIdIndex();
        ((SubjectReplanData) arrayList.get(indexOne)).setIdIndex(((SubjectReplanData) arrayList.get(indexTwo)).getIdIndex());
        ((SubjectReplanData) arrayList.get(indexTwo)).setIdIndex(tempIndex);
        SubjectReplanData temp = (SubjectReplanData) arrayList.get(indexOne);
    ...
    public void setCheeseList(ArrayList<SubjectReplanData> subjectList) {
