...
public class RayLayout extends ViewGroup {
	...
	private  Rect computeChildFrame(final boolean expanded, final int paddingRight, final int childIndex,
        ...
        final int left =  (expanded ? (paddingRight + childIndex * (gap + size) + (0)) :this.getWidth()-(size /2));
	...
	private static Animation createShrinkAnimation(float fromXDelta, float toXDelta, float fromYDelta, float toYDelta,
		...
		Animation translateAnimation = new RotateAndTranslateAnimation(fromXDelta, toXDelta, fromYDelta, toYDelta, 360, 720);
