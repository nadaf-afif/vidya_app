...
//indraneel 10
    ...
    private boolean isChildAnimatedOnce = false;*/
...
//
    ...
    private int computeRadius(final float arcDegrees, final int childCount, final int childSize,
        ...
        int radius = (int) ((perSize / 1) / Math.sin(Math.toRadians(perHalfDegrees)));

        radius = getPxFromDp(120);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
        	...
        	if(child instanceof ImageView) {
        		logMessage("Child is Image View");
        		...
        		logMessage("Child is not ImageView");        		
        		child.measure(MeasureSpec.makeMeasureSpec(mChildSize, MeasureSpec.EXACTLY),
        				MeasureSpec.makeMeasureSpec(mChildSize, MeasureSpec.EXACTLY));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        logMessage("in onLayout");
        
        /*if(!isChildAnimatedOnce)
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            /*if(child instanceof ImageView && !isChildAnimatedOnce) {
            	logMessage("Child is image View");
            	child.setVisibility(View.INVISIBLE);
            	childs.add(child);
            } else {
            	logMessage("Child is not image view");
            }*/
